...
const DEFAULT_PHONE = "+1 (386) 453-9277";
const TEL_LINK = "tel:+1 (386) 453-9277";
            ...
            <div className="sticky top-24">
              <Card className="rounded-2xl overflow-hidden shadow-xl">
                <div className="aspect-video relative">
                  <img
                    src={`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkGeDUvFLxU_SMI32iQ-KduOQL6e2Lxdr-3Q&s`}
                    alt={servicesList[activeService].title}
                    className="w-full h-full object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
                  <div className="absolute bottom-4 left-4 text-white">
                    <h3 className="text-2xl font-bold mb-2">{servicesList[activeService].title}</h3>
                    <p className="text-white/90 mb-4">{servicesList[activeService].description}</p>
